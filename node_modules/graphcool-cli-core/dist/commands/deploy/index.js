...
var Deploy = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(interactive || (!newServiceCluster && !foundTarget.target) || (newServiceName && !newServiceCluster))) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        if (!(newServiceName || interactive || (!foundTarget.targetName && !foundTarget.target))) return [3 /*break*/, 5];
                    ...
                    case 15:
                        ...
                        if (watch) {
                            ...
                            chokidar.watch(this.config.definitionDir, { ignoreInitial: true }).on('all', function () {
                    ...
                    case 0:
                        question = {
                            ...
                            choices: [
                                ...
                                new inquirer.Separator(chalk_1.default.bold('Local (docker):')),
                                {
                                    value: 'local',
                                    name: 'local',
                                },
    ...
    Deploy.help = "\n  \n  " + chalk_1.default.green.bold('Examples:') + "\n      \n" + chalk_1.default.gray('-') + " Deploy local changes from graphcool.yml to the default service environment.\n  " + chalk_1.default.green('$ graphcool deploy') + "\n\n" + chalk_1.default.gray('-') + " Deploy local changes to a specific target\n  " + chalk_1.default.green('$ graphcool deploy --target production') + "\n    \n" + chalk_1.default.gray('-') + " Deploy local changes from default service file accepting potential data loss caused by schema changes\n  " + chalk_1.default.green('$ graphcool deploy --force --env production') + "\n  ";
    Deploy.flags = {
