...
var Playground = /** @class */ (function (_super) {
    ...
    Playground.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, target, web, id, localPlaygroundPath;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (fs.pathExistsSync(localPlaygroundPath) && !web) {
                            childProcess.spawn(localPlaygroundPath, ['--endpoint', this.env.simpleEndpoint(id), '--platform-token', this.env.token], { detached: true });
                        }
                        else {
