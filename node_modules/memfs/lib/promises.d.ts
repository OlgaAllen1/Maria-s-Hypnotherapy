...
import { Volume, TFilePath, TData, TMode, TFlags, TFlagsCopy, TSymlinkType, TTime, IOptions, IAppendFileOptions, IMkdirOptions, IReaddirOptions, IReadFileOptions, IRealpathOptions, IWriteFileOptions } from './volume';
import { Stats, Dirent } from './node';
import { TDataOut } from './encoding';
export declare type TFileHandleReadResult = {
    bytesRead: number;
    buffer: Buffer | Uint8Array;
};
export declare type TFileHandleWriteResult = {
    bytesWritten: number;
    buffer: Buffer | Uint8Array;
};
