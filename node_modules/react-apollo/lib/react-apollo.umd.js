(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-dom/server'), require('apollo-client')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-dom/server', 'apollo-client'], factory) :
    (factory((global['react-apollo'] = {}),global.React,global.PropTypes,global.ReactDOM,global.apolloClient));
}(this, (function (exports,React,PropTypes,ReactDOM,apolloClient) { 'use strict';
    ...
    function getDataFromTree(rootElement, renderFunction) {
        if (renderFunction === void 0) { renderFunction = ReactDOM.renderToStaticMarkup; }
