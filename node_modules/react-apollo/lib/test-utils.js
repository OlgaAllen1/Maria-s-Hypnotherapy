(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-dom/server'), require('apollo-client'), require('apollo-link'), require('graphql/language/printer'), require('apollo-utilities'), require('apollo-cache-inmemory')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-dom/server', 'apollo-client', 'apollo-link', 'graphql/language/printer', 'apollo-utilities', 'apollo-cache-inmemory'], factory) :
    (factory((global['react-apollo'] = {}),global.React,global.PropTypes,global.ReactDOM,global.ApolloClient,global.apolloLink,global.printer,global.apolloUtilities,global.apolloCacheInmemory));
}(this, (function (exports,React,PropTypes,ReactDOM,ApolloClient,apolloLink,printer,apolloUtilities,apolloCacheInmemory) { 'use strict';
