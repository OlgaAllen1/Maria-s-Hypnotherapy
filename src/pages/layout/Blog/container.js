...
import sanUrl from './sanfrann.jpg'

export default class Blog extends Component {
  render () {
    const tabHead = { backgroundColor: "rgb(218, 176, 229)" }
    return(
      <div style={tabHead}>
        <MuiThemeProvider>
          <Paper className='history' style={style} zDepth={5} rounded={true}>
             <div className='h'>
                  <div className="hh">
                    <form>
                  ...
                  <img className='sanfran' src = {sanUrl} />
             </div>
          </Paper>
